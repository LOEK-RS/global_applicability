...
r_rcv = loadModel("sla/reproduced_randomcv")
r_scv = loadModel("sla/reproduced_spatialcv")
r_fcv = loadModel("sla/reproduced_featurecv03")
...
```{r}
r_ccv_errormodel = readRDS("sla/reproduced_combinedcv/errormodel.RDS")
r_ccv_performance = readRDS("sla/reproduced_combinedcv/performance.RDS")
...
```{r}
r_ccv_expectedError = raster("sla/reproduced_combinedcv/expected_error.grd")

tm_shape(r_ccv_expectedError)+
    tm_raster(palette = viridis::viridis(50), style = "cont", breaks = c(0,1,2,3,4,5))
```
...
s_rcv = loadModel("sla/svs_randomcv")
s_scv = loadModel("sla/svs_spatialcv")
s_fcv = loadModel("sla/svs_featurecv03")
...
```{r}
s_ccv_errormodel = readRDS("sla/svs_combinedcv/errormodel.RDS")
s_ccv_performance = readRDS("sla/svs_combinedcv/performance.RDS")
...
```{r}
s_ccv_expectedError = raster("sla/svs_combinedcv/expected_error.grd")
